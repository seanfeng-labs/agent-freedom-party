---
name: libpdf-js-conventional-commit
description: Add and commit changes using conventional commits
---

Create a git commit for the current changes using the Conventional Commits standard, and use Chinese for the commit message.
...
5. **Write the commit message**:
    ...
    - **Body** (if needed): Explain _why_, not _what_ in Chinese
...
Simple change (Chinese subject):

```
fix(parser): 处理空输入避免报错
```

With body (Chinese subject and body):
